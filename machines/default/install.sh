...
# set bash colors
set_not_env 'PS1_COLOR_NAME'   '"\[\033[01;34m\]"' # Blue
set_not_env 'PS1_COLOR_DIR'    '"\[\033[01;34m\]"' # Blue
set_not_env 'PS1_COLOR_PROMPT' '"\[\033[01;34m\]"' # Green
set_not_env 'PS1_COLOR_CMD'    '"\[\033[00m\]"'    # White
set_not_env 'PS1_NAME'         '"\u "'
set_not_env 'PS1_DIR'          '"\W "'
set_not_env 'PS1_PROMPT'       '"\$ "'
